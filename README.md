...
## Data Used
This project uses data scraped from [Sean Casey Animal Rescue](https://www.nyanimalrescue.org/). It was scraped using Selenium (Python). The final dataset can be found in pets.csv
...
Other animal shelter sites prevented scraping their data due to security reasons. There would be better visualizations if there were more data/attributes. 
